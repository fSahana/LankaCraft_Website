...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            <!-- First Part: Checkout Form -->
            <div class="col-lg-8 mb-5">
                <h2 class="mb-4">Checkout</h2>
                <form action="handler/orderCheckout_handler.php" method="POST">
                    <!-- Personal Details -->
                    <div class="mb-3">
                        <label>Last Name</label>
                        <input type="text" class="form-control" name="LastName" placeholder="Your Last Name" value="<?php echo $l_name; ?>" readonly>
                    </div>
                    <div class="mb-3">
                       <label>Phone Number</label>
                       <input type="text" class="form-control" name="phone" placeholder="Phone Number" value="<?php echo $_SESSION["phone"]; ?>" readonly>
                    </div>
                    <div class="mb-3">
                       <label>Address</label>
                    ...
                    <div class="mb-3">
                        <label for="card-name" class="form-label">Visa</label>
                    </div>
                    <div class="mb-3">
                        <label for="card-number" class="form-label">Card Number</label>
                        <input type="password" name="cardno" class="form-control" id="card-number" placeholder="Enter card number" required>
                    </div>
                    <button type="submit" class="btn btn-block btn-primary py-3" style="background-color: #7971ea;">Proceed the Order</button>
                </form>
            </div>
